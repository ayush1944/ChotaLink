...
import { getAllUserUrls } from '../../api/createShortUrl'
...
const UserUrl = () => {
  ...
  // Create a new array instead of modifying the original with reverse()
              ...
              <tr key={url._id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <div className="text-sm text-gray-900">
                    <span className="px-2 inline-flex text-xs leading-5 font-semibold text-center rounded-full  text-blue-800">
